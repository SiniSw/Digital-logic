...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/Ñ¸À×ÏÂÔØ/Digital-logic-master/WashingmachineCS/WashingmachineCS.cache/wt [current_project]
  set_property parent.project_path D:/Ñ¸À×ÏÂÔØ/Digital-logic-master/WashingmachineCS/WashingmachineCS.xpr [current_project]
  set_property ip_repo_paths d:/Ñ¸À×ÏÂÔØ/Digital-logic-master/WashingmachineCS/WashingmachineCS.cache/ip [current_project]
  set_property ip_output_repo d:/Ñ¸À×ÏÂÔØ/Digital-logic-master/WashingmachineCS/WashingmachineCS.cache/ip [current_project]
  add_files -quiet D:/Ñ¸À×ÏÂÔØ/Digital-logic-master/WashingmachineCS/WashingmachineCS.runs/synth_1/MainSystem.dcp
  read_xdc D:/Ñ¸À×ÏÂÔØ/Digital-logic-master/WashingmachineCS/Nexys4DDR_Master.xdc
